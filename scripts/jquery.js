...
!function (a, b) {
  ...
  r.extend = r.fn.extend = function () {
    ...
    d = a[b],
    g !== d && (j && d && (r.isPlainObject(d) || (e = Array.isArray(d))) ? (e ? (e = !1, f = c && Array.isArray(c) ? c : [
  ...
  r.fn.extend({
    ...
    filter: function (a) {
      return this.pushStack(E(this, a || [
      ], !1))
    },
    not: function (a) {
      return this.pushStack(E(this, a || [
            ...
            return function () {
              ...
              j = function () {
                ...
                if (!(b < f)) {
                  ...
                  r.isFunction(j) ? e ? j.call(a, g(f, c, N, e), g(f, c, O, e))  : (f++, j.call(a, g(f, c, N, e), g(f, c, O, e), g(f, c, N, c.notifyWith)))  : (d !== N && (h = void 0, i = [
                    a
                  ]), (e || c.resolveWith) (h, i))
                }
              },
  ...
  function hb(a, b, c) {
    ...
    ]).concat(kb.tweeners['*']), f = 0, g = e.length; f < g; f++) if (d = e[f].call(c, b, a)) return d
  }
  function ib(a, b, c) {
    var d,
    e,
    ...
    if (i = !r.isEmptyObject(b), i || !r.isEmptyObject(n)) {
      l && 1 === a.nodeType && (c.overflow = [
        ...
        o.overflowX,
        o.overflowY
      ], j = q && q.display, null == j && (j = W.get(a, 'display')), k = r.css(a, 'display'), 'none' === k && (j ? k = j : (ia([a], !0), j = a.style.display || j, k = r.css(a, 'display'), ia([a]))), ('inline' === k || 'inline-block' === k && null != j) && 'none' === r.css(a, 'float') && (i || (m.done(function () {
        o.display = j
  ...
  function Mb(a) {
    return function (b, c) {
      ...
      if (r.isFunction(c)) while (d = f[e++]) '+' === d[0] ? (d = d.slice(1) || '*', (a[d] = a[d] || [
      ]).unshift(c))  : (a[d] = a[d] || [
      ]).push(c)
    }
  }
